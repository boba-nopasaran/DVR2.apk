...
.method public static buildCanonicalizedResource(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)Ljava/lang/String;
    ...
    sget-object v9, Lcom/alibaba/sdk/android/oss/common/utils/OSSUtils;->SIGNED_PARAMTERS:Ljava/util/List;
...
.method public static buildXMLFromPartEtagList(Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lcom/alibaba/sdk/android/oss/model/PartETag;->getETag()Ljava/lang/String;
...
.method public static paramToQueryString(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v5, p1}, Lcom/alibaba/sdk/android/oss/common/utils/HttpUtil;->urlEncode(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static signRequest(Lcom/alibaba/sdk/android/oss/internal/RequestMessage;)V
    ...
    const-string v20, "\u5f53\u524dCredentialProvider\u4e3a\u7a7a\uff01\uff01\uff01\n1. \u8bf7\u68c0\u67e5\u60a8\u662f\u5426\u5728\u521d\u59cb\u5316OSSService\u65f6\u8bbe\u7f6eCredentialProvider;\n2. \u5982\u679c\u60a8bucket\u4e3a\u516c\u5171\u6743\u9650\uff0c\u8bf7\u786e\u8ba4\u83b7\u53d6\u5230Bucket\u540e\u5df2\u7ecf\u8c03\u7528Bucket\u4e2d\u63a5\u53e3\u58f0\u660eACL;"
    ...
    check-cast v19, Lcom/alibaba/sdk/android/oss/common/auth/OSSFederationCredentialProvider;

    invoke-virtual/range {v19 .. v19}, Lcom/alibaba/sdk/android/oss/common/auth/OSSFederationCredentialProvider;->getValidFederationToken()Lcom/alibaba/sdk/android/oss/common/auth/OSSFederationToken;
    ...
    invoke-static/range {v19 .. v19}, Lcom/alibaba/sdk/android/oss/common/OSSLog;->logE(Ljava/lang/String;)V

    new-instance v19, Ljava/io/IOException;

    const-string v20, "Can\'t get a federation token"
    ...
    const-string v20, "x-oss-security-token"
    ...
    invoke-virtual/range {v19 .. v19}, Lcom/alibaba/sdk/android/oss/common/HttpMethod;->toString()Ljava/lang/String;
    ...
    check-cast v19, Lcom/alibaba/sdk/android/oss/common/auth/OSSStsTokenCredentialProvider;

    invoke-virtual/range {v19 .. v19}, Lcom/alibaba/sdk/android/oss/common/auth/OSSStsTokenCredentialProvider;->getFederationToken()Lcom/alibaba/sdk/android/oss/common/auth/OSSFederationToken;
    ...
    :cond_8
    new-instance v19, Lcom/alibaba/sdk/android/oss/common/utils/OSSUtils$1;

    invoke-direct/range {v19 .. v19}, Lcom/alibaba/sdk/android/oss/common/utils/OSSUtils$1;-><init>()V
    ...
    invoke-static/range {v19 .. v21}, Lcom/alibaba/sdk/android/oss/common/utils/OSSUtils;->buildCanonicalizedResource(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)Ljava/lang/String;
    ...
    const-string v20, "signed content: "
    ...
    invoke-static/range {v19 .. v19}, Lcom/alibaba/sdk/android/oss/common/OSSLog;->logD(Ljava/lang/String;)V
    ...
    check-cast v19, Lcom/alibaba/sdk/android/oss/common/auth/OSSPlainTextAKSKCredentialProvider;

    invoke-virtual/range {v19 .. v19}, Lcom/alibaba/sdk/android/oss/common/auth/OSSPlainTextAKSKCredentialProvider;->getAccessKeyId()Ljava/lang/String;
