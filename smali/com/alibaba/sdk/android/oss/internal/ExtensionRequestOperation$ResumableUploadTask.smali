...
.method private initUploadId()V
    ...
    invoke-virtual {v15}, Lcom/alibaba/sdk/android/oss/model/ResumableUploadRequest;->getUploadFilePath()Ljava/lang/String;
    ...
    invoke-static {v14}, Lcom/alibaba/sdk/android/oss/common/utils/BinaryUtil;->calculateMd5Str(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/alibaba/sdk/android/oss/model/ResumableUploadRequest;->getBucketName()Ljava/lang/String;
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/alibaba/sdk/android/oss/model/ResumableUploadRequest;->getObjectKey()Ljava/lang/String;
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/alibaba/sdk/android/oss/model/ResumableUploadRequest;->getPartSize()J
    ...
    invoke-static {v15}, Lcom/alibaba/sdk/android/oss/common/utils/BinaryUtil;->calculateMd5Str([B)Ljava/lang/String;
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/alibaba/sdk/android/oss/model/ResumableUploadRequest;->getRecordDirectory()Ljava/lang/String;
    ...
    iput-object v15, v0, Lcom/alibaba/sdk/android/oss/internal/ExtensionRequestOperation$ResumableUploadTask;->recordFile:Ljava/io/File;
    ...
    iput-object v15, v0, Lcom/alibaba/sdk/android/oss/internal/ExtensionRequestOperation$ResumableUploadTask;->uploadId:Ljava/lang/String;
    ...
    const-string v16, "[initUploadId] - Found record file, uploadid: "
    ...
    new-instance v9, Lcom/alibaba/sdk/android/oss/model/ListPartsRequest;
    ...
    invoke-direct {v9, v15, v0, v1}, Lcom/alibaba/sdk/android/oss/model/ListPartsRequest;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    move-object/from16 v0, p0

    iget-object v15, v0, Lcom/alibaba/sdk/android/oss/internal/ExtensionRequestOperation$ResumableUploadTask;->this$0:Lcom/alibaba/sdk/android/oss/internal/ExtensionRequestOperation;

    invoke-static {v15}, Lcom/alibaba/sdk/android/oss/internal/ExtensionRequestOperation;->access$000(Lcom/alibaba/sdk/android/oss/internal/ExtensionRequestOperation;)Lcom/alibaba/sdk/android/oss/internal/InternalRequestOperation;
    ...
    invoke-virtual {v15, v9, v0}, Lcom/alibaba/sdk/android/oss/internal/InternalRequestOperation;->listParts(Lcom/alibaba/sdk/android/oss/model/ListPartsRequest;Lcom/alibaba/sdk/android/oss/callback/OSSCompletedCallback;)Lcom/alibaba/sdk/android/oss/internal/OSSAsyncTask;

    move-result-object v13

    :try_start_0
    invoke-virtual {v13}, Lcom/alibaba/sdk/android/oss/internal/OSSAsyncTask;->getResult()Lcom/alibaba/sdk/android/oss/model/OSSResult;

    move-result-object v15

    check-cast v15, Lcom/alibaba/sdk/android/oss/model/ListPartsResult;

    invoke-virtual {v15}, Lcom/alibaba/sdk/android/oss/model/ListPartsResult;->getParts()Ljava/util/List;
    ...
    check-cast v10, Lcom/alibaba/sdk/android/oss/model/PartSummary;
    ...
    invoke-virtual {v10}, Lcom/alibaba/sdk/android/oss/model/PartSummary;->getPartNumber()I

    move-result v17

    invoke-virtual {v10}, Lcom/alibaba/sdk/android/oss/model/PartSummary;->getETag()Ljava/lang/String;
    ...
    new-instance v15, Lcom/alibaba/sdk/android/oss/ClientException;

    new-instance v16, Ljava/lang/StringBuilder;

    invoke-direct/range {v16 .. v16}, Ljava/lang/StringBuilder;-><init>()V

    const-string v17, "Can\'t create file at path: "
    ...
    invoke-direct/range {v15 .. v16}, Lcom/alibaba/sdk/android/oss/ClientException;-><init>(Ljava/lang/String;)V
    ...
    :cond_2
    new-instance v7, Lcom/alibaba/sdk/android/oss/model/InitiateMultipartUploadRequest;
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/alibaba/sdk/android/oss/model/ResumableUploadRequest;->getMetadata()Lcom/alibaba/sdk/android/oss/model/ObjectMetadata;
    ...
    invoke-direct {v7, v15, v0, v1}, Lcom/alibaba/sdk/android/oss/model/InitiateMultipartUploadRequest;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/alibaba/sdk/android/oss/model/ObjectMetadata;)V
    ...
    invoke-virtual {v15, v7, v0}, Lcom/alibaba/sdk/android/oss/internal/InternalRequestOperation;->initMultipartUpload(Lcom/alibaba/sdk/android/oss/model/InitiateMultipartUploadRequest;Lcom/alibaba/sdk/android/oss/callback/OSSCompletedCallback;)Lcom/alibaba/sdk/android/oss/internal/OSSAsyncTask;

    move-result-object v15

    invoke-virtual {v15}, Lcom/alibaba/sdk/android/oss/internal/OSSAsyncTask;->getResult()Lcom/alibaba/sdk/android/oss/model/OSSResult;

    move-result-object v8

    check-cast v8, Lcom/alibaba/sdk/android/oss/model/InitiateMultipartUploadResult;

    invoke-virtual {v8}, Lcom/alibaba/sdk/android/oss/model/InitiateMultipartUploadResult;->getUploadId()Ljava/lang/String;
    ...
    invoke-direct/range {v15 .. v16}, Ljava/io/FileWriter;-><init>(Ljava/io/File;)V
...
.method public call()Lcom/alibaba/sdk/android/oss/model/ResumableUploadResult;
    ...
    invoke-interface {v3, v4, v2}, Lcom/alibaba/sdk/android/oss/callback/OSSCompletedCallback;->onSuccess(Lcom/alibaba/sdk/android/oss/model/OSSRequest;Lcom/alibaba/sdk/android/oss/model/OSSResult;)V
    :try_end_0
    .catch Lcom/alibaba/sdk/android/oss/ServiceException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Lcom/alibaba/sdk/android/oss/ClientException; {:try_start_0 .. :try_end_0} :catch_1
    ...
    invoke-interface {v3, v4, v5, v1}, Lcom/alibaba/sdk/android/oss/callback/OSSCompletedCallback;->onFailure(Lcom/alibaba/sdk/android/oss/model/OSSRequest;Lcom/alibaba/sdk/android/oss/ClientException;Lcom/alibaba/sdk/android/oss/ServiceException;)V
    ...
    invoke-interface {v3, v4, v1, v5}, Lcom/alibaba/sdk/android/oss/callback/OSSCompletedCallback;->onFailure(Lcom/alibaba/sdk/android/oss/model/OSSRequest;Lcom/alibaba/sdk/android/oss/ClientException;Lcom/alibaba/sdk/android/oss/ServiceException;)V
    ...
    invoke-direct {v0, v3, v1}, Lcom/alibaba/sdk/android/oss/ClientException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-interface {v3, v4, v0, v5}, Lcom/alibaba/sdk/android/oss/callback/OSSCompletedCallback;->onFailure(Lcom/alibaba/sdk/android/oss/model/OSSRequest;Lcom/alibaba/sdk/android/oss/ClientException;Lcom/alibaba/sdk/android/oss/ServiceException;)V
