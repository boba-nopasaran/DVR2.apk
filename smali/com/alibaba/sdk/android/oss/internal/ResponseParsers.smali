...
.method private static parseCompleteMultipartUploadResponseXML(Ljava/io/InputStream;)Lcom/alibaba/sdk/android/oss/model/CompleteMultipartUploadResult;
    ...
    new-instance v7, Lcom/alibaba/sdk/android/oss/model/CompleteMultipartUploadResult;

    invoke-direct {v7}, Lcom/alibaba/sdk/android/oss/model/CompleteMultipartUploadResult;-><init>()V

    sget-object v8, Lcom/alibaba/sdk/android/oss/internal/ResponseParsers;->domFactory:Ljavax/xml/parsers/DocumentBuilderFactory;
    ...
    invoke-virtual {v7, v8}, Lcom/alibaba/sdk/android/oss/model/CompleteMultipartUploadResult;->setLocation(Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v8}, Lcom/alibaba/sdk/android/oss/model/CompleteMultipartUploadResult;->setBucketName(Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v8}, Lcom/alibaba/sdk/android/oss/model/CompleteMultipartUploadResult;->setObjectKey(Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v8}, Lcom/alibaba/sdk/android/oss/model/CompleteMultipartUploadResult;->setETag(Ljava/lang/String;)V
...
.method private static parseCopyObjectResponseXML(Ljava/io/InputStream;)Lcom/alibaba/sdk/android/oss/model/CopyObjectResult;
    ...
    new-instance v7, Lcom/alibaba/sdk/android/oss/model/CopyObjectResult;

    invoke-direct {v7}, Lcom/alibaba/sdk/android/oss/model/CopyObjectResult;-><init>()V
    ...
    invoke-virtual {v7, v8}, Lcom/alibaba/sdk/android/oss/model/CopyObjectResult;->setLastModified(Ljava/util/Date;)V
    ...
    invoke-virtual {v7, v8}, Lcom/alibaba/sdk/android/oss/model/CopyObjectResult;->setEtag(Ljava/lang/String;)V
...
.method private static parseGetBucketACLResponse(Ljava/io/InputStream;)Lcom/alibaba/sdk/android/oss/model/GetBucketACLResult;
    ...
    new-instance v16, Lcom/alibaba/sdk/android/oss/model/GetBucketACLResult;

    invoke-direct/range {v16 .. v16}, Lcom/alibaba/sdk/android/oss/model/GetBucketACLResult;-><init>()V
    ...
    invoke-static/range {v17 .. v17}, Lcom/alibaba/sdk/android/oss/common/OSSLog;->logD(Ljava/lang/String;)V
    ...
    invoke-static {v13}, Lcom/alibaba/sdk/android/oss/internal/ResponseParsers;->checkChildNotNullAndGetValue(Lorg/w3c/dom/Node;)Ljava/lang/String;

    move-result-object v17

    invoke-virtual/range {v16 .. v17}, Lcom/alibaba/sdk/android/oss/model/GetBucketACLResult;->setBucketOwnerID(Ljava/lang/String;)V
    ...
    invoke-virtual/range {v16 .. v17}, Lcom/alibaba/sdk/android/oss/model/GetBucketACLResult;->setBucketOwner(Ljava/lang/String;)V
    ...
    invoke-virtual/range {v16 .. v17}, Lcom/alibaba/sdk/android/oss/model/GetBucketACLResult;->setBucketACL(Ljava/lang/String;)V
...
.method private static parseInitMultipartResponseXML(Ljava/io/InputStream;)Lcom/alibaba/sdk/android/oss/model/InitiateMultipartUploadResult;
    ...
    new-instance v7, Lcom/alibaba/sdk/android/oss/model/InitiateMultipartUploadResult;

    invoke-direct {v7}, Lcom/alibaba/sdk/android/oss/model/InitiateMultipartUploadResult;-><init>()V
    ...
    invoke-virtual {v7, v8}, Lcom/alibaba/sdk/android/oss/model/InitiateMultipartUploadResult;->setUploadId(Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v8}, Lcom/alibaba/sdk/android/oss/model/InitiateMultipartUploadResult;->setBucketName(Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v8}, Lcom/alibaba/sdk/android/oss/model/InitiateMultipartUploadResult;->setObjectKey(Ljava/lang/String;)V
...
.method private static parseListPartsResponseXML(Ljava/io/InputStream;)Lcom/alibaba/sdk/android/oss/model/ListPartsResult;
    ...
    new-instance v22, Lcom/alibaba/sdk/android/oss/model/ListPartsResult;

    invoke-direct/range {v22 .. v22}, Lcom/alibaba/sdk/android/oss/model/ListPartsResult;-><init>()V
    ...
    invoke-static/range {v24 .. v24}, Lcom/alibaba/sdk/android/oss/common/OSSLog;->logD(Ljava/lang/String;)V
...
.method private static parseObjectListResponse(Ljava/io/InputStream;)Lcom/alibaba/sdk/android/oss/model/ListObjectsResult;
    ...
    new-instance v10, Lcom/alibaba/sdk/android/oss/model/ListObjectsResult;

    invoke-direct {v10}, Lcom/alibaba/sdk/android/oss/model/ListObjectsResult;-><init>()V

    sget-object v11, Lcom/alibaba/sdk/android/oss/internal/ResponseParsers;->domFactory:Ljavax/xml/parsers/DocumentBuilderFactory;
    ...
    const-string v12, "[parseObjectListResponse] - "
    ...
    invoke-static {v11}, Lcom/alibaba/sdk/android/oss/common/OSSLog;->logD(Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v11}, Lcom/alibaba/sdk/android/oss/model/ListObjectsResult;->setBucketName(Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v11}, Lcom/alibaba/sdk/android/oss/model/ListObjectsResult;->setPrefix(Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v11}, Lcom/alibaba/sdk/android/oss/model/ListObjectsResult;->setMarker(Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v11}, Lcom/alibaba/sdk/android/oss/model/ListObjectsResult;->setDelimiter(Ljava/lang/String;)V

    goto :goto_1

    :cond_5
    const-string v11, "EncodingType"
    ...
    invoke-virtual {v10, v11}, Lcom/alibaba/sdk/android/oss/model/ListObjectsResult;->setEncodingType(Ljava/lang/String;)V

    goto :goto_1

    :cond_6
    const-string v11, "MaxKeys"
    ...
    invoke-virtual {v10, v11}, Lcom/alibaba/sdk/android/oss/model/ListObjectsResult;->setMaxKeys(I)V

    goto :goto_1

    :cond_7
    const-string v11, "NextMarker"
    ...
    invoke-virtual {v10, v11}, Lcom/alibaba/sdk/android/oss/model/ListObjectsResult;->setNextMarker(Ljava/lang/String;)V

    goto :goto_1

    :cond_8
    const-string v11, "IsTruncated"
    ...
    invoke-virtual {v10, v11}, Lcom/alibaba/sdk/android/oss/model/ListObjectsResult;->setTruncated(Z)V
    ...
    invoke-virtual {v10}, Lcom/alibaba/sdk/android/oss/model/ListObjectsResult;->getObjectSummaries()Ljava/util/List;
    ...
    invoke-static {v12}, Lcom/alibaba/sdk/android/oss/internal/ResponseParsers;->parseObjectSummaryXML(Lorg/w3c/dom/NodeList;)Lcom/alibaba/sdk/android/oss/model/OSSObjectSummary;
    ...
    :cond_a
    const-string v11, "CommonPrefixes"
    ...
    invoke-static {v11}, Lcom/alibaba/sdk/android/oss/internal/ResponseParsers;->parseCommonPrefixXML(Lorg/w3c/dom/NodeList;)Ljava/lang/String;

    move-result-object v9

    if-eqz v9, :cond_0

    invoke-virtual {v10}, Lcom/alibaba/sdk/android/oss/model/ListObjectsResult;->getCommonPrefixes()Ljava/util/List;
